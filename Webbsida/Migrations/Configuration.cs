    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(Webbsida.Models.ApplicationDbContext context)
        {
            ...
            var ec3 = new Event
            {
                Name = "Dockteater",
                Description =
                    "Vi på Norrlandsoperan kommmer att hålla dockteatrar alla torsdagskvällar under oktober månad, med start den 6/10 kl 19:00 ",
            ...
            var ec4 = new Event
            {
                Name = "Företagsjippo",
                Description =
                    "Företaget Umeå intresseklubbs företagsjippo kommer i år att hålla till på Norrbyskär, där vi kommer att ha både tält och karuseller och det kommer i år att vara öppen för allmänheten. Vi kommer både att ha karuseller och hoppborg för de yngre.",
            ...
            var ec5 = new Event
            {
                ...
                Description =
                    "Vårt företag, Svenska metaller och plaster, kommer att befinna oss på arbetsförmedlingen under veckosluten för att presentera oss och för att intresserade ska kunna komma och prata med oss. Vi söker speciellt ingenjörer som är utbildade inom plast och metallindustrin.",
            ...
            var ec6 = new Event
            {
                Name = "Älgkontakt",
                Description =
                    "Vårt företag, Älgens hus, vill att barn och ungdomar ska få en närmare tillvaron till naturen så vi kommer att hålla helgförmiddagarna öppna med både besök i hagen och testa på med workshops med utbildade ledare och naturkännare. Kom på en dag för att lära dig mer om den svenska naturen.   ",
            ...
            var ec7 = new Event
            {
                Name = "Språkskola",
                Description =
                    "Vårt kompisgäng har ansökt om att lära oss spanska, men men det behövs minst 1 till, så någon som är manat att lära sig spanska får gärna ansluta sig till oss. Då vi studerar på umu, så ser vi helst att kursen går på kvällen, och då medelåldern är 25 år, så ser vi gärna att din ålder är i närheten av detta.   ",
            ...
            var ec8 = new Event
            {
                Name = "pubafton",
                Description =
                    "Jag är ensam, men lust att festa loss i helgen, är ni några som vill festa loss med mig, så träffas vi på Allstar kl 21:00. ",
                StartDate = new DateTime(2017, 01, 9, 09, 00, 00),
                EndDate = new DateTime(2017, 01, 9, 12, 00, 00),
                Latitude = GenerateRandomLatitude(),
                Longitude = GenerateRandomLongitude(),
            ...
            var ec9 = new Event
            {
                ...
                Description =
                    "Vi kommer att hålla igång med allsång varje måndag kväll på vänortsparken, det är bara att dyka upp med en picknickkorg och sjunga med oss.",
            ...
            var ec10 = new Event
            {
                ...
                Description =
                    "Dagen innan säsongen börjar kommer det vara istid för barnen, där barn i åldrarna 3-7 år får komma ut på isen och lära sig åka skridskor, vi kommer även sponsra med besök av några av våra a-lagspelare. som visar sina konster.",
            ...
            var ec11 = new Event
            {
                ...
                Description =
                    "Dagen innan säsonen börjar kommer det vara full ös i Noliahallarna av barn mellan 3-7 år som får komma och lära sig olika bollsporter.",
            ...
            var companyInfo = new CompanyInformation
            {
                ...
                Description =
                    "Vi är ett företag som arbetar för att människor ska kunna knyta nya kontakter via egengjorda event. ",
